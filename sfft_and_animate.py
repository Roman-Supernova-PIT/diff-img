...
# IMPORTS Internal:
from phrosty.imagesubtraction import sky_subtract, imalign, get_imsim_psf, rotate_psf, crossconvolve, difference, decorr_kernel, decorr_img
...
def check_overlap(ra,dec,temp_path,sci_path,overlap_size=500,verbose=False):
    """
