import cupy as cp
import numpy as np
from SFFTSolutionReader import Realize_MatchingKernel
    ...
    def SSCFN(hdr_REF, hdr_oSCI, PixA_REF_GPU, PixA_oSCI_GPU, PixA_REF_DMASK_GPU, PixA_oSCI_DMASK_GPU, 
        ...
        with nvtx.annotate("1-crossConv", color="#C51B8A"):
            PixA_CREF_GPU = PureCupy_FFTKits.FFT_CONVOLVE(PixA_Inp_GPU=PixA_REF_GPU, KERNEL_GPU=PSF_SCI_GPU, 
                PAD_FILL_VALUE=0., NAN_FILL_VALUE=None, NORMALIZE_KERNEL=True, FORCE_OUTPUT_C_CONTIGUOUS=True, FFT_BACKEND="NVMATH")  # WARNING: changed from "NVMATH" to "NVMATH"

            PixA_CSCI_GPU = PureCupy_FFTKits.FFT_CONVOLVE(PixA_Inp_GPU=PixA_SCI_GPU, KERNEL_GPU=PSF_REF_GPU,
                PAD_FILL_VALUE=0., NAN_FILL_VALUE=None, NORMALIZE_KERNEL=True, FORCE_OUTPUT_C_CONTIGUOUS=True, FFT_BACKEND="NVMATH")  # WARNING: changed from "Cupy" to "NVMATH"
        ...
        with nvtx.annotate("sfft6-handle_diff_blank", color="#714CF9"):
