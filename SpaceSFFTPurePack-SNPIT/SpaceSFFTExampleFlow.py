...
GDIR = '/hildafs/projects/phy220048p/leihu/AstroWork/RomanSNPIT/SpaceSFFTPurePack'
...
# dry run to skip the compilation time
if True:
    ...
    # dry run to see the compilation time
    PixA_DIFF_GPU, PixA_DCDIFF_GPU, PixA_DSNR_GPU = SpaceSFFT_CupyFlow.SSCF(hdr_REF=hdr_REF, hdr_oSCI=hdr_oSCI, 
    ...
    # os.system("rm %s %s" % (FITS_DCDIFF, FITS_DSNR))
